package com.project.ph_reco.pharmacy.cache;
...
public class PharmacyRedisTemplateService {
    ...
    public List<PharmacyDto> findAll() {
        try {
            ...
            for (String value : hashOperations.entries(CACHE_KEY).values()) {
                PharmacyDto pharmacyDto = deserialzePharmacyDto(value);
    ...
    private PharmacyDto deserialzePharmacyDto(String value) throws JsonProcessingException {
